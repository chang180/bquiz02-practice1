...
<div class="tags" id="t1">健康新知</div
><div class="tags" id="t2">菸害防制</div
><div class="tags" id="t3">癌症防治</div
><div class="tags" id="t4">慢性病防制</div
>
<article id="p1">
<span>健康新知</span>
<pre>
...
<script>
    ...
    $(".tags").on("mousedown",function(){
        let post="#"+$(this).attr("id").replace("t","p");
        showPost(post);
    })
    let showPost=(id)=>{
        let tag=id.replace("p","t");
        $("article").hide();
        $(id).show();
        $(".tags").css("background","lightgray");
